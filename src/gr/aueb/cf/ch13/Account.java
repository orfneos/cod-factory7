package src.gr.aueb.cf.ch13;

import src.gr.aueb.cf.ch13.exceptions.InsufficientBalanceException;
import src.gr.aueb.cf.ch13.exceptions.NegativeAmountException;
import src.gr.aueb.cf.ch13.exceptions.SsnNotValidException;
...
//                throw new Exception("The amount must not be negative.");
            ...
            System.out.println("Error. Amount " + amount + "cannot be negative");
           // e.printStackTrace();
            throw e;
        }
    }
    ...
    /**
     * Withdraws an amount of money for the {@link Account}
     ...
     *          the given ssn.
     * @throws Exception
     *          if the ssn is not valid or the valance is not sufficient or
